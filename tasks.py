...
class TravelTasks:
    ...
    def plan_itinerary(self, agent, city, travel_dates, interests):
        ...
        """
            ...
            agent=agent,
            expected_output=f"A detailed 7-day itinerary for {city} from {travel_dates} based on the traveler's interests: {interests}. Include accommodation, food options, and daily activities."
        )
    ...
    def identify_city(self, agent, origin, cities, interests, travel_dates):
        ...
        """
            ...
            agent=agent,
            expected_output = "A detailed report identifying the best city for the trip, including flight costs, weather forecast, upcoming events, and top attractions for the travel dates and traveler interests."
        )
    ...
    def gather_city_info(self, agent, city, travel_dates, interests):
        ...
        """
            ...
            agent=agent,
            expected_output = "An in-depth city guide that covers key attractions, local customs, special events, weather forecast, daily activity recommendations, and cost estimates for the selected city and travel dates."
        )
